...
<head>
    ...
    <title>Halle Berry VIP | Exclusive Fan Portal</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <div class="logo">
                ...
                <div class="logo-text">HB VIP</div>
            </div>
    ...
    <main id="mainContent">
        ...
        <section class="hero" id="home">
            <div class="container">
                <div class="hero-content">
                    <h1>The Ultimate <span>Halle Berry</span> VIP Experience</h1>
                    <p>An exclusive, invitation-only portal for Halle Berry's most dedicated patrons. Access unparalleled experiences, personal interactions, and content unavailable anywhere else in the world.</p>
            ...
            <div class="features">
                <div class="feature-card">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Unrestricted access to Halle's personal archives, unreleased projects, and exclusive behind-the-scenes footage from her entire career.</p>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="feature-content">
                        ...
                        <p>VIP seating at all premieres, exclusive after-parties, and private screenings with Halle and industry insiders.</p>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Private dinners, set visits, one-on-one conversations, and personalized video messages from Halle Berry herself.</p>
                    </div>
                </div>
                ...
                <div class="content-grid">
                    <div class="content-card">
                        ...
                        <div class="content-overlay">
                            <h3>Behind The Scenes: "The Union"</h3>
                    ...
                    <div class="content-card">
                        ...
                        <div class="content-overlay">
                            ...
                            <p>Join Halle on a personal trip back to his roots in Scotland</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="container tiers" id="tiers">
            ...
            <div class="tier-cards">
                ...
                <div class="tier-card featured">
                    ...
                    <ul class="tier-features">
                        ...
                        <li class="featured"><i class="fas fa-check"></i> Personal video message from Halle</li>
                ...
                <div class="tier-card">
                    ...
                    <ul class="tier-features">
                        ...
                        <li><i class="fas fa-check"></i> Private dinner with Halle (1 annually)</li>
                        <li><i class="fas fa-check"></i> Unlimited set visits (subject to scheduling)</li>
                        <li><i class="fas fa-check"></i> Original props from Halle's films</li>
            ...
            <div style="text-align: center; margin-top: 50px; max-width: 800px; margin-left: auto; margin-right: auto;">
                ...
                <p style="color: rgba(255, 255, 255, 0.8);">For those seeking truly unique experiences, we offer fully customized membership packages starting at $75,000 annually. These include personalized experiences, investment opportunities in Halle's projects, and unparalleled access. Contact our membership director for a private consultation.</p>
            ...
            <div class="container">
                <div class="footer-content">
                    <div class="footer-column">
                        <h3>HB VIP Portal</h3>
                        <p>The ultimate exclusive community for Halle Berry's most dedicated patrons. An invitation-only experience offering unparalleled access and bespoke interactions.</p>
                    ...
                    <div class="footer-column">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><i class="fas fa-phone"></i> +1 (888) 555-HBVIP</li>
                ...
                <div class="copyright">
                    <p>&copy; 2023 Halle Berry VIP Portal. All rights reserved. This is an exclusive, invitation-only community. All memberships are subject to approval.</p>
                </div>
            </div>
        </footer>
    </main>
        ...
        <div class="dashboard-header">
            <div class="container">
                <div class="dashboard-welcome">
                    ...
                    <p id="dashboardUserEmail">Your exclusive portal to all Halle Berry VIP content and experiences</p>
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="user-info">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">HB-VIP-2023-00142</span>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="membership-status">
                        ...
                        <p>Your membership renews on: <strong>January, 2027</strong></p>
                ...
                <div class="dashboard-card">
                    ...
                    <ul class="exclusive-access-list">
                        ...
                        <li class="access-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Personal video message from Halle</span>
                        </li>
                        <li class="access-item">
                            <i class="fas fa-check-circle"></i>
                    ...
                    <ul class="recent-activity">
                        <li class="activity-item">
                            ...
                            <div class="activity-content">
                                ...
                                <p>"Behind The Scenes: The Union"</p>
                        ...
                        <li class="activity-item">
                            ...
                            <div class="activity-content">
                                ...
                                <p>Virtual Q&A with Halle Berry</p>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="content-grid" style="grid-template-columns: 1fr; margin-top: 20px;">
                        <div class="content-card" style="height: 200px;">
                            ...
                            <img src="https://images.unsplash.com/photo-1489599809516-9827b6d1cf13?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Behind the Scenes">
                            <div class="content-overlay">
                                <h3>Halle's Workout Routine</h3>
                                <p>Exclusive look at Halle's fitness regimen</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="login-popup-overlay" id="loginPopup">
        <div class="login-popup">
            ...
            <p>Access your exclusive Halle Berry VIP portal</p>
    ...
    <div class="success-popup-overlay" id="successPopup">
        <div class="success-popup">
            ...
            <p id="successMessage">Congratulations! You have successfully logged into your Halle Berry's VIP portal. You now have access to exclusive content, member-only events, and the entire HB VIP experience.</p>
    ...
    <script>
        ...
        loginForm.addEventListener('submit', (e) => {
            ...
            localStorage.setItem('hb_vip_user_name', name);
            localStorage.setItem('hb_vip_user_email', email);
            
            // Close login popup
            loginPopup.classList.remove('active');
            
            // Update success message with user's name
            successMessage.innerHTML = `Congratulations <strong>${name}</strong>! You have successfully logged into your Halle Berry VIP portal. You now have exclusive access to all VIP content, member-only events, and the entire HB VIP experience.`;
        ...
        explorePortalBtn.addEventListener('click', () => {
            ...
            const userName = localStorage.getItem('hb_vip_user_name') || 'VIP Member';
            const userEmail = localStorage.getItem('hb_vip_user_email') || 'vip@example.com';
        ...
        logoutBtn.addEventListener('click', () => {
            // Clear user data
            localStorage.removeItem('hb_vip_user_name');
            localStorage.removeItem('hb_vip_user_email');
